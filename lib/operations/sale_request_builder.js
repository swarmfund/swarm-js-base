    ...
    _createClass(SaleRequestBuilder, null, {
        createSaleCreationRequest: {
            ...
            value: function createSaleCreationRequest(opts) {
                ...
                var withdrawRequestOp = new xdr.CreateSaleCreationRequestOp({
        ...
        manageSale: {
            value: function manageSale(opts) {
                var attrs = {};
        ...
        manageSaleOpToObject: {
            value: function manageSaleOpToObject(result, attrs) {
                result.saleId = attrs.saleId().toString();
