...
var SaleTypes = require("../util/sale_types").SaleTypes;
    ...
    _createClass(SaleRequestBuilder, null, {
        ...
        validateSaleCreationRequest: {
            value: function validateSaleCreationRequest(opts) {
                ...
                if (hasBaseAssetForHardCap && isUndefined(opts.saleState) && attrs.saleType !== saleTypesEnum.FixedPrice) {
                ...
                } else if (attrs.saleType === saleTypesEnum.FixedPrice && (!hasBaseAssetForHardCap || isUndefined(opts.saleState))) {
