...
xdr.enum("ManageOfferResultCode", {
  ...
  saleAlreadyEnded: -15,
  orderExceedsHardCap: -16,
  cannotParticipateOwnSale: -17,
  assetMismatched: -18,
  priceMismatched: -19,
  invalidPrice: -20,
  offerUpdateIsNotAllowed: -21,
  invalidAmount: -22,
  saleIsNotActive: -23,
  requiresKyc: -24,
  requiresIsBuy: -25,
...
//
// ===========================================================================
xdr.struct("OfferTotalAmount", [
  ["baseAmount", xdr.lookup("Int64")],
  ["quoteAmount", xdr.lookup("Int64")],
  ["ext", xdr.lookup("OfferTotalAmountExt")],
]);
...
xdr.union("ManageOfferSuccessResultOffer", {
  ...
  arms: {
    ...
    totalAmount: xdr.lookup("OfferTotalAmount"),
  },
  defaultArm: xdr.void(),
});
