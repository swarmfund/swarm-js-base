// Automatically generated on 2017-11-22T20:34:56+02:00
...
//
// ===========================================================================
xdr.enum("ManageCoinsEmissionRequestAction", {
  manageCoinsEmissionRequestCreate: 0,
  manageCoinsEmissionRequestDelete: 1,
});
...
//
// ===========================================================================
xdr.union("ManageCoinsEmissionRequestOpExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("ManageCoinsEmissionRequestOp", [
  ["action", xdr.lookup("ManageCoinsEmissionRequestAction")],
  ...
  ["ext", xdr.lookup("ManageCoinsEmissionRequestOpExt")],
]);
...
//
// ===========================================================================
xdr.enum("ManageCoinsEmissionRequestResultCode", {
  manageCoinsEmissionRequestSuccess: 0,
  manageCoinsEmissionRequestInvalidAmount: -1,
  manageCoinsEmissionRequestInvalidRequestId: -2,
  manageCoinsEmissionRequestNotFound: -3,
  manageCoinsEmissionRequestAlreadyReviewed: -4,
  manageCoinsEmissionRequestAssetNotFound: -5,
  manageCoinsEmissionRequestBalanceNotFound: -6,
  manageCoinsEmissionRequestAssetMismatch: -7,
  manageCoinsEmissionRequestInvalidAsset: -8,
  manageCoinsEmissionRequestReferenceDuplication: -9,
  manageCoinsEmissionRequestLineFull: -10,
  manageCoinsEmissionRequestInvalidReference: -11,
});
...
//
// ===========================================================================
xdr.union("ManageCoinsEmissionRequestResultManageRequestInfoExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("ManageCoinsEmissionRequestResultManageRequestInfo", [
  ["requestId", xdr.lookup("Uint64")],
  ["fulfilled", xdr.bool()],
  ["ext", xdr.lookup("ManageCoinsEmissionRequestResultManageRequestInfoExt")],
]);
...
//
// ===========================================================================
xdr.union("ManageCoinsEmissionRequestResult", {
  switchOn: xdr.lookup("ManageCoinsEmissionRequestResultCode"),
  switchName: "code",
  switches: [
    ["manageCoinsEmissionRequestSuccess", "manageRequestInfo"],
  ],
  arms: {
    manageRequestInfo: xdr.lookup("ManageCoinsEmissionRequestResultManageRequestInfo"),
  },
  defaultArm: xdr.void(),
});
...
//
// ===========================================================================
xdr.struct("PreEmission", [
  ["serialNumber", xdr.lookup("String64")],
  ["asset", xdr.lookup("AssetCode")],
  ["amount", xdr.lookup("Int64")],
  ["signatures", xdr.varArray(xdr.lookup("DecoratedSignature"), 20)],
  ["ext", xdr.lookup("PreEmissionExt")],
]);
...
//
// ===========================================================================
xdr.union("UploadPreemissionsOpExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("UploadPreemissionsOp", [
  ["preEmissions", xdr.varArray(xdr.lookup("PreEmission"), 2147483647)],
  ["ext", xdr.lookup("UploadPreemissionsOpExt")],
]);
...
//
// ===========================================================================
xdr.enum("UploadPreemissionsResultCode", {
  uploadPreemissionsSuccess: 0,
  uploadPreemissionsMalformed: -1,
  uploadPreemissionsSerialDuplication: -2,
  uploadPreemissionsMalformedPreemission: -3,
  uploadPreemissionsAssetNotFound: -4,
  uploadPreemissionsLineFull: -5,
});
...
//
// ===========================================================================
xdr.union("UploadPreemissionsResultSuccessExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("UploadPreemissionsResultSuccess", [
  ["ext", xdr.lookup("UploadPreemissionsResultSuccessExt")],
]);
...
//
// ===========================================================================
xdr.union("UploadPreemissionsResult", {
  switchOn: xdr.lookup("UploadPreemissionsResultCode"),
  switchName: "code",
  switches: [
    ["uploadPreemissionsSuccess", "success"],
  ],
  arms: {
    success: xdr.lookup("UploadPreemissionsResultSuccess"),
  },
  defaultArm: xdr.void(),
});
...
//
// ===========================================================================
xdr.union("LedgerKeyCoinsEmissionRequestExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("LedgerKeyCoinsEmissionRequest", [
  ["issuer", xdr.lookup("AccountId")],
  ["requestId", xdr.lookup("Uint64")],
  ["ext", xdr.lookup("LedgerKeyCoinsEmissionRequestExt")],
]);
...
//
// ===========================================================================
xdr.union("LedgerKeyCoinsEmissionExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("LedgerKeyCoinsEmission", [
  ["serialNumber", xdr.lookup("String64")],
  ["ext", xdr.lookup("LedgerKeyCoinsEmissionExt")],
]);
...
//
// ===========================================================================
xdr.struct("LedgerKeyPayment", [
  ["sender", xdr.lookup("AccountId")],
  ["reference", xdr.lookup("String64")],
  ["ext", xdr.lookup("LedgerKeyPaymentExt")],
]);
...
xdr.union("LedgerKey", {
  ...
  switches: [
    ["account", "account"],
    ["coinsEmissionRequest", "coinsEmissionRequest"],
    ["coinsEmission", "coinsEmission"],
    ["fee", "feeState"],
    ["balance", "balance"],
  ...
  arms: {
    ...
    coinsEmissionRequest: xdr.lookup("LedgerKeyCoinsEmissionRequest"),
    coinsEmission: xdr.lookup("LedgerKeyCoinsEmission"),
    ...
    payment: xdr.lookup("LedgerKeyPayment"),
...
xdr.union("OperationBody", {
  ...
  switches: [
    ...
    ["manageCoinsEmissionRequest", "manageCoinsEmissionRequestOp"],
    ["reviewCoinsEmissionRequest", "reviewCoinsEmissionRequestOp"],
    ["setFee", "setFeesOp"],
    ...
    ["uploadPreemission", "uploadPreemissionsOp"],
  ...
  arms: {
    ...
    manageCoinsEmissionRequestOp: xdr.lookup("ManageCoinsEmissionRequestOp"),
    reviewCoinsEmissionRequestOp: xdr.lookup("ReviewCoinsEmissionRequestOp"),
    ...
    uploadPreemissionsOp: xdr.lookup("UploadPreemissionsOp"),
...
xdr.union("OperationResultTr", {
  ...
  switches: [
    ...
    ["manageCoinsEmissionRequest", "manageCoinsEmissionRequestResult"],
    ["reviewCoinsEmissionRequest", "reviewCoinsEmissionRequestResult"],
    ...
    ["uploadPreemission", "uploadPreemissionsResult"],
  ...
  arms: {
    ...
    manageCoinsEmissionRequestResult: xdr.lookup("ManageCoinsEmissionRequestResult"),
    reviewCoinsEmissionRequestResult: xdr.lookup("ReviewCoinsEmissionRequestResult"),
    ...
    uploadPreemissionsResult: xdr.lookup("UploadPreemissionsResult"),
...
xdr.struct("ManageAssetOp", [
  ["action", xdr.lookup("ManageAssetAction")],
  ["code", xdr.lookup("AssetCode")],
...
xdr.enum("ManageAssetResultCode", {
  ...
  manageAssetNotFound: -1,
  manageAssetAlreadyExist: -2,
  manageAssetMalformed: -3,
});
...
xdr.enum("AssetPolicy", {
  assetTransferable: 1,
  assetEmittablePrimary: 2,
  assetEmittableSecondary: 4,
});
...
xdr.enum("OperationType", {
  ...
  payment: 1,
  setOption: 2,
  manageCoinsEmissionRequest: 3,
  reviewCoinsEmissionRequest: 4,
  setFee: 5,
  manageAccount: 6,
...
//
// ===========================================================================
xdr.union("CoinsEmissionRequestEntryExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("CoinsEmissionRequestEntry", [
  ["requestId", xdr.lookup("Uint64")],
  ["reference", xdr.lookup("String64")],
  ["receiver", xdr.lookup("BalanceId")],
  ["issuer", xdr.lookup("AccountId")],
  ...
  ["asset", xdr.lookup("AssetCode")],
  ["isApproved", xdr.bool()],
  ["ext", xdr.lookup("CoinsEmissionRequestEntryExt")],
]);
...
//
// ===========================================================================
xdr.union("CoinsEmissionEntryExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("CoinsEmissionEntry", [
  ["serialNumber", xdr.lookup("String64")],
  ["amount", xdr.lookup("Int64")],
  ["asset", xdr.lookup("AssetCode")],
  ["ext", xdr.lookup("CoinsEmissionEntryExt")],
]);
...
//
// ===========================================================================
xdr.union("ReviewCoinsEmissionRequestOpExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("ReviewCoinsEmissionRequestOp", [
  ["request", xdr.lookup("CoinsEmissionRequestEntry")],
  ["approve", xdr.bool()],
  ["reason", xdr.lookup("String64")],
  ["ext", xdr.lookup("ReviewCoinsEmissionRequestOpExt")],
]);
...
//
// ===========================================================================
xdr.enum("ReviewCoinsEmissionRequestResultCode", {
  reviewCoinsEmissionRequestSuccess: 0,
  reviewCoinsEmissionRequestInvalidReason: -1,
  reviewCoinsEmissionRequestNotFound: -2,
  reviewCoinsEmissionRequestNotEqual: -3,
  reviewCoinsEmissionRequestAlreadyReviewed: -4,
  reviewCoinsEmissionRequestMalformed: -5,
  reviewCoinsEmissionRequestNotEnoughPreemission: -6,
  reviewCoinsEmissionRequestLineFull: -9,
  reviewCoinsEmissionRequestAssetNotFound: -10,
  reviewCoinsEmissionRequestBalanceNotFound: -11,
  reviewCoinsEmissionRequestReferenceDuplication: -12,
});
...
//
// ===========================================================================
xdr.union("ReviewCoinsEmissionRequestResultSuccessExt", {
  switchOn: xdr.lookup("LedgerVersion"),
  switchName: "v",
  switches: [
    ["emptyVersion", xdr.void()],
...
//
// ===========================================================================
xdr.struct("ReviewCoinsEmissionRequestResultSuccess", [
  ["requestId", xdr.lookup("Uint64")],
  ["ext", xdr.lookup("ReviewCoinsEmissionRequestResultSuccessExt")],
]);
...
//
// ===========================================================================
xdr.union("ReviewCoinsEmissionRequestResult", {
  switchOn: xdr.lookup("ReviewCoinsEmissionRequestResultCode"),
  switchName: "code",
  switches: [
    ["reviewCoinsEmissionRequestSuccess", "success"],
  ],
  arms: {
    success: xdr.lookup("ReviewCoinsEmissionRequestResultSuccess"),
  },
  defaultArm: xdr.void(),
});
...
xdr.union("LedgerEntryData", {
  ...
  arms: {
    ...
    coinsEmissionRequest: xdr.lookup("CoinsEmissionRequestEntry"),
    feeState: xdr.lookup("FeeEntry"),
    coinsEmission: xdr.lookup("CoinsEmissionEntry"),
    balance: xdr.lookup("BalanceEntry"),
    paymentRequest: xdr.lookup("PaymentRequestEntry"),
    asset: xdr.lookup("AssetEntry"),
    payment: xdr.lookup("ReferenceEntry"),
