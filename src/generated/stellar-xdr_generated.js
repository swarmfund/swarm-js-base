// Automatically generated on 2018-03-07T13:44:10+02:00
...
//
// ===========================================================================
xdr.struct("SaleEntrySaleStates", [
...
xdr.union("SaleEntryExt", {
  ...
  switches: [
    ...
    ["allowToManageSale", "saleStates"],
  ],
  arms: {
    saleTypeExt: xdr.lookup("SaleTypeExt"),
    saleStates: xdr.lookup("SaleEntrySaleStates"),
  },
});
...
xdr.struct("ManageSaleOp", [
  ["saleId", xdr.lookup("Uint64")],
  ["action", xdr.lookup("ManageSaleAction")],
