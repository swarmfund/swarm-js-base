// Automatically generated on 2018-01-10T17:35:58+02:00
...
xdr.struct("UpdateKycRequest", [
  ["dataKyc", xdr.lookup("Longstring")],
  ["accountTypeBeforeUpdate", xdr.lookup("AccountType")],
...
//
// ===========================================================================
xdr.struct("UpdateKycData", [
  ["dataKyc", xdr.lookup("Longstring")],
  ["requestId", xdr.lookup("Uint64")],
  ["ext", xdr.lookup("UpdateKycDataExt")],
]);
...
xdr.struct("SetOptionsOp", [
  ...
  ["updateKycData", xdr.option(xdr.lookup("UpdateKycData"))],
...
xdr.enum("SetOptionsResultCode", {
  ...
  updateKycMalformed: -8,
  updateKycRequestNotFound: -9,
});
